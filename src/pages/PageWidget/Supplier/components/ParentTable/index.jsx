...
class ParentTable extends Component {
  ...
  getCustomTool = () => {
    ...
    return (
      <>
        <FormPopover onSave={this.handleSave} isSaving={loading.effects['supplier/saveParent']}>
          <Button type="link">
  ...
  renderDelBtn = row => {
    ...
    if (loading.effects['supplier/delPRow'] && delRowId === row.id) {
  ...
  getListCardProps = () => {
    ...
    return {
      ...
      store: {
        type: 'POST',
        url: `${MDMSCONTEXT}/supplier/findByPage`,
      },
      remotePaging: true,
          ...
          return (
            <Space>
              <FormPopover
                ...
                isSaving={loading.effects['supplier/saveParent']}
                editData={item}
              >
