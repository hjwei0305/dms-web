...
class ParentTable extends Component {
    ...
    return (
      <>
        {/* <FormPopover
          ...
          isSaving={loading.effects['personnel/saveParent']}
        >
          <Button type="link">
  ...
  renderDelBtn = row => {
    ...
    if (loading.effects['personnel/delPRow'] && delRowId === row.id) {
