...
export async function saveParent(data) {
  const url = `${MDMSCONTEXT}/customer/save`;
  return request({
    url,
    method: 'POST',
    data,
...
export async function saveChild(data) {
  const url = `${MDMSCONTEXT}/customer/saveCorporationInfo`;
  return request({
    url,
    method: 'POST',
    data,
...
export async function delParentRow({ id }) {
  const url = `${MDMSCONTEXT}/customer/delete/${id}`;
  return request({
    url,
    method: 'DELETE',
  });
...
export async function delChildRow({ id }) {
  const url = `${MDMSCONTEXT}/customer/deleteCorporationInfo/${id}`;
  return request({
    url,
    method: 'DELETE',
  });
