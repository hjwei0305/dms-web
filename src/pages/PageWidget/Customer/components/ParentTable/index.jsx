...
class ParentTable extends Component {
  ...
  getCustomTool = () => {
    ...
    return (
      <>
        <FormPopover onSave={this.handleSave} isSaving={loading.effects['customer/saveParent']}>
          <Button type="link">
  ...
  renderDelBtn = row => {
    ...
    if (loading.effects['customer/delPRow'] && delRowId === row.id) {
  ...
  getListCardProps = () => {
    ...
    return {
      ...
      store: {
        type: 'POST',
        url: `${MDMSCONTEXT}/customer/findByPage`,
      },
      remotePaging: true,
          ...
          return (
            <Space>
              <FormPopover
                ...
                isSaving={loading.effects['customer/saveParent']}
                editData={item}
              >
