...
class ParentTable extends Component {
  ...
  handleSave = (data, cb) => {
    ...
    dispatch({
      type: 'corpPaymentBankAccount/saveParent',
      payload: data,
    }).then(result => {
    ...
    return (
      <>
        {/* <FormPopover
          ...
          isSaving={loading.effects['corpPaymentBankAccount/saveParent']}
        >
          <Button type="link">
  ...
  renderDelBtn = row => {
    ...
    if (loading.effects['corpPaymentBankAccount/delPRow'] && delRowId === row.id) {
  ...
  del = record => {
    ...
    this.setState(
      ...
      () => {
        dispatch({
          type: 'corpPaymentBankAccount/delPRow',
          payload: {
            id: record.id,
          },
        }).then(res => {
  ...
  getListCardProps = () => {
    ...
    return {
      ...
      onSelectChange: (_, [selectedItem]) => {
        ...
        // .then(() => {
        //   dispatch({
        //     type: 'corpPaymentBankAccount/getConfigById',
        //     payload: {
        //       id: selectedItem.id,
        //     },
        //   });
